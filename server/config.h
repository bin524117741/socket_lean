...
extern void traverseList(ListNode *pList);
extern int clearList(ListNode *pList);
extern int isOnLine(ListNode *list , User user);
extern ListNode *list_reversd(ListNode *pList);
extern int insertListTail(ListNode *pList, User user);
extern int insertListHead(ListNode *pList, User user);
extern void list_init(ListNode **pList);
